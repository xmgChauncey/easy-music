...
- [x] Windows SMTC 锁屏媒体信息和系统音量浮层联动
- [x] 扫描目录管理与移除
- [x] 播放队列拖放排序
- [x] 最近播放历史迁移到 SQLite
- [x] 音乐库缓存清理与数据位置打开按钮
